      ...
      <div className={styles.innerWrapper}>
        ...
        <form>
          ...
          <label className={`${styles.odd} ${styles.amountInput}`}>
            ...
            <span><Trans>Ne représente aucunement un engagement</Trans>.</span>
          </label>
          ...
          <label>
            ...
            />
            <span>
              <Trans>Les document attestant la provenance des fonds seront demandés</Trans>.
            </span>
          </label>
          <label className={styles.odd}>
            <Trans>Message</Trans>
          ...
          <div className={styles.formTextBottom}>(*) <Trans>Champs obligatoires</Trans></div>
          <button><Trans>Envoyer la demande</Trans></button>
        </form>
      </div>
    </section>
  );
